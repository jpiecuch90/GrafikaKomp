...
void GenerateDisplayLists()
{
	...
	glBegin(GL_TRIANGLES);
	//Okna na ścianie przedniej
	// okno1
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-.90, -.40, 1.01);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(-.450, -.40, 1.01);
	...
	// okno 2
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-.20, -.40, 1.01);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(.250, -.40, 1.01);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(.250, .40, 1.01);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-.20, -.40, 1.01);
	...
	glTexCoord2f(0.0, 1.0);
	glVertex3f(.90, .40, -1.01);
	// Okna na lewej bocznej ścianie 
	//okno 7
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-1.01 , -.40 ,-.90 );
	glTexCoord2f(1.0, 0.0);
	glVertex3f(-1.01, -.40, -.450);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(-1.01, .40, -.450 );
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-1.01, -.40, -.90);
	...
	//okno 8
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-1.01, -.40, .20);
	glTexCoord2f(1.0, 0.0);
	glVertex3f(-1.01, -.40, -.250);
	glTexCoord2f(1.0, 1.0);
	glVertex3f(-1.01, .40, -.250);
	glTexCoord2f(0.0, 0.0);
	glVertex3f(-1.01, -.40, .20);
